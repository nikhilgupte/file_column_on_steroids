...
3. Enter the following config variables in your environment.rb file:
	FileColumn::S3FileColumnExtension::Config.s3_access_key_id = YOUR_S3_ACCESS_KEY
	FileColumn::S3FileColumnExtension::Config.s3_secret_access_key = YOUR_S3_SECRET
	FileColumn::S3FileColumnExtension::Config.s3_bucket_name = THE_BUCKET_WHERE_THE_UPLOADED_FILE_SHOULD_BE_STORED
	FileColumn::S3FileColumnExtension::Config.s3_distribution_url = THE_S3_OR_CLOUD_FRONT_URL_OF_YOUR_BUCKET
...
You can look at the rdoc-generated documentation in the "doc" directory for the original documentation.
I'm still working on documenting the new features in detail.
